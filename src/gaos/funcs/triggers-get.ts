...
export function triggersGet(
  ...
  Result<
    triggers.Trigger,
    | errors.GetTriggerClientError
    | errors.GetTriggerServerError
    | GoogleGenAiError
    | ConnectionError
    | RequestAbortedError
    | RequestTimeoutError
...
> {
  const input: operations.GetTriggerRequest = {
    id: id,
  };
  ...
  const [result] = await M.match<
    ...
    | UnexpectedClientError
  >(
    M.jsonErr<errors.GetTriggerClientError>(
      "4XX",
      errors.GetTriggerClientError,
    ),
    M.jsonErr<errors.GetTriggerServerError>(
      "5XX",
      errors.GetTriggerServerError,
    ),
