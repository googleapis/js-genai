...
export function agentsGet(
  ...
  Result<
    agents.Agent,
    | errors.GetAgentClientError
    | errors.GetAgentServerError
    | GoogleGenAiError
    | ConnectionError
    | RequestAbortedError
    | RequestTimeoutError
...
> {
  ...
  const [result] = await M.match<
    ...
    | UnexpectedClientError
  >(
    M.jsonErr<errors.GetAgentClientError>("4XX", errors.GetAgentClientError),
    M.jsonErr<errors.GetAgentServerError>("5XX", errors.GetAgentServerError),
