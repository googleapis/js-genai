 ...
 */
export function environmentsGetEnvironmentFiles(
  ...
  Result<
    interactions.GetEnvironmentFilesResponse,
    | GoogleGenAiError
    | ConnectionError
    | RequestAbortedError
    | RequestTimeoutError
...
> {
  ...
  const path$ = pathToFunc("/v1beta/environments/{environment}/files/{path}")(
    pathParams,
  );
  ...
  >(
    M.fail("4XX"),
    M.fail("5XX"),
    M.json<interactions.GetEnvironmentFilesResponse>("default"),
  )(response, req);
  if (!result.ok) {
