 ...
 * interface is compatible with OpenAPI 3.0 schema objects while the
 ...
 */
export function responseSchemaFromZod(
  vertexai: boolean,
  zodSchema: z.ZodType,
): Schema {
...
export interface ZodFunction {
  name: string;
  zodFunctionSchema: z.ZodFunction<z.ZodTuple<any, any>, z.ZodTypeAny>;
}

export function functionDeclarationFromZod(
  vertaxai: boolean,
  ...
  // Only allow function with one parameter, and the parameter is an object.
