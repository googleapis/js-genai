 ...
 * filtering for prompts and responses. It helps protect your AI applications from
 * risks such as harmful content, sensitive data leakage, and prompt injection
 * attacks.
 */
...
export declare namespace Interactions {
  export {
    ...
    type Model as Model,
    type ModelArmorConfig as ModelArmorConfig,
