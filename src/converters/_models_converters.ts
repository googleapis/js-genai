...
export function embedContentParametersToMldev(
  ...
  if (fromContents != null) {
    common.setValueByPath(
      toObject,
      ['requests[]', 'content'],
      transformers.tContentsForEmbed(apiClient, fromContents),
    );
  }
  ...
  if (fromModelForEmbedContent !== undefined) {
    common.setValueByPath(
      toObject,
      ['requests[]', 'model'],
      transformers.tModel(apiClient, fromModelForEmbedContent),
    );
  }
...
export function listModelsConfigToMldev(
  ...
  if (parentObject !== undefined && fromQueryBase != null) {
    common.setValueByPath(
      parentObject,
      ['_url', 'models_url'],
      transformers.tModelsUrl(apiClient, fromQueryBase),
    );
  }
...
export function imageToMldev(fromObject: types.Image): Record<string, unknown> {
  ...
  if (fromImageBytes != null) {
    common.setValueByPath(
      toObject,
      ['bytesBase64Encoded'],
      baseTransformers.tBytes(fromImageBytes),
    );
  }
...
export function generateContentConfigToVertex(
  ...
  if (fromResponseSchema != null) {
    common.setValueByPath(
      toObject,
      ['responseSchema'],
      schemaToVertex(transformers.tSchema(fromResponseSchema)),
    );
  }
  ...
  if (fromSpeechConfig != null) {
    common.setValueByPath(
      toObject,
      ['speechConfig'],
      speechConfigToVertex(transformers.tSpeechConfig(fromSpeechConfig)),
    );
  }
...
export function videoToVertex(
  ...
  if (fromVideoBytes != null) {
    common.setValueByPath(
      toObject,
      ['bytesBase64Encoded'],
      baseTransformers.tBytes(fromVideoBytes),
    );
  }
...
export function listModelsResponseFromMldev(
  ...
  if (fromModels != null) {
    let transformedList = transformers.tExtractModels(fromModels);
    if (Array.isArray(transformedList)) {
      transformedList = transformedList.map((item) => {
