...
export class Models extends BaseModule {
  ...
  /**
   * In place replaces the McpClients for a Callable implementation using th McpCallableTool class.
   */
  private processMcpClients(params: types.GenerateContentParameters) {
    ...
    return (async function* (
      ...
      while (remoteCallCount < maxRemoteCalls) {
        ...
        if (functionResponses.length > 0) {
          ...
          transformedParams.contents = updatedContents;
        } else {
          break;
        }
      }
