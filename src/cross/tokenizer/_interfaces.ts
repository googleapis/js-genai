...
export interface TokenizerCache {
   ...
   * @returns Cached model data if valid, null otherwise
   */
...
export interface ILocalTokenizer {
   ...
   * @returns A CountTokensResult containing the total number of tokens
   */
  countTokens(
   ...
   *
   * @param contents The contents to tokenize
   * @returns A ComputeTokensResult containing token IDs, bytes, and roles
   */
