...
export function batchJobDestinationFromMldev(fromObject) {
    const toObject = {};
    ...
    if (fromInlinedEmbedContentResponses != null) {
        ...
        common.setValueByPath(toObject, ['inlinedEmbedContentResponses'], transformedList);
    }
    return toObject;
}
export function batchJobDestinationFromVertex(fromObject) {
    const toObject = {};
...
export function batchJobDestinationToVertex(fromObject) {
    const toObject = {};
    ...
    if (fromGcsUri != null) {
        common.setValueByPath(toObject, ['gcsDestination', 'outputUriPrefix'], fromGcsUri);
    }
    const fromBigqueryUri = common.getValueByPath(fromObject, ['bigqueryUri']);
    if (fromBigqueryUri != null) {
        common.setValueByPath(toObject, ['bigqueryDestination', 'outputUri'], fromBigqueryUri);
    }
    ...
    if (common.getValueByPath(fromObject, ['inlinedEmbedContentResponses']) !==
        undefined) {
        throw new Error('inlinedEmbedContentResponses parameter is not supported in Vertex AI.');
    }
    return toObject;
}
export function batchJobFromMldev(fromObject) {
    const toObject = {};
    ...
    if (fromDest != null) {
        common.setValueByPath(toObject, ['dest'], batchJobDestinationFromMldev(t.tRecvBatchJobDestination(fromDest)));
    }
    return toObject;
}
export function batchJobFromVertex(fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['name'], fromName);
    ...
    if (fromDest != null) {
        common.setValueByPath(toObject, ['dest'], batchJobDestinationFromVertex(t.tRecvBatchJobDestination(fromDest)));
    }
...
export function batchJobSourceFromVertex(fromObject) {
    const toObject = {};
...
export function batchJobSourceToMldev(apiClient, fromObject) {
    const toObject = {};
...
export function batchJobSourceToVertex(fromObject) {
    const toObject = {};
    const fromFormat = common.getValueByPath(fromObject, ['format']);
    if (fromFormat != null) {
    ...
    const fromBigqueryUri = common.getValueByPath(fromObject, ['bigqueryUri']);
    if (fromBigqueryUri != null) {
        common.setValueByPath(toObject, ['bigquerySource', 'inputUri'], fromBigqueryUri);
    }
    if (common.getValueByPath(fromObject, ['fileName']) !== undefined) {
        throw new Error('fileName parameter is not supported in Vertex AI.');
    }
...
export function cancelBatchJobParametersToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], t.tBatchJobName(apiClient, fromName));
    }
    return toObject;
}
export function cancelBatchJobParametersToVertex(apiClient, fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], t.tBatchJobName(apiClient, fromName));
...
export function createBatchJobConfigToMldev(fromObject, parentObject) {
    const toObject = {};
    const fromDisplayName = common.getValueByPath(fromObject, ['displayName']);
    if (parentObject !== undefined && fromDisplayName != null) {
        common.setValueByPath(parentObject, ['batch', 'displayName'], fromDisplayName);
    }
...
export function createBatchJobConfigToVertex(fromObject, parentObject) {
    const toObject = {};
    const fromDisplayName = common.getValueByPath(fromObject, ['displayName']);
    if (parentObject !== undefined && fromDisplayName != null) {
    ...
    if (parentObject !== undefined && fromDest != null) {
        common.setValueByPath(parentObject, ['outputConfig'], batchJobDestinationToVertex(t.tBatchJobDestination(fromDest)));
    }
    return toObject;
}
export function createBatchJobParametersToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromModel = common.getValueByPath(fromObject, ['model']);
    if (fromModel != null) {
    ...
    if (fromSrc != null) {
        common.setValueByPath(toObject, ['batch', 'inputConfig'], batchJobSourceToMldev(apiClient, t.tBatchJobSource(apiClient, fromSrc)));
    }
...
export function createBatchJobParametersToVertex(apiClient, fromObject) {
    const toObject = {};
    const fromModel = common.getValueByPath(fromObject, ['model']);
    if (fromModel != null) {
    ...
    const fromSrc = common.getValueByPath(fromObject, ['src']);
    if (fromSrc != null) {
        common.setValueByPath(toObject, ['inputConfig'], batchJobSourceToVertex(t.tBatchJobSource(apiClient, fromSrc)));
    }
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function createEmbeddingsBatchJobConfigToMldev(fromObject, parentObject) {
    const toObject = {};
    const fromDisplayName = common.getValueByPath(fromObject, ['displayName']);
    if (parentObject !== undefined && fromDisplayName != null) {
        common.setValueByPath(parentObject, ['batch', 'displayName'], fromDisplayName);
...
export function createEmbeddingsBatchJobParametersToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromModel = common.getValueByPath(fromObject, ['model']);
    if (fromModel != null) {
        common.setValueByPath(toObject, ['_url', 'model'], t.tModel(apiClient, fromModel));
    ...
    const fromSrc = common.getValueByPath(fromObject, ['src']);
    if (fromSrc != null) {
        common.setValueByPath(toObject, ['batch', 'inputConfig'], embeddingsBatchJobSourceToMldev(apiClient, fromSrc));
    }
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function deleteBatchJobParametersToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], t.tBatchJobName(apiClient, fromName));
...
export function deleteBatchJobParametersToVertex(apiClient, fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], t.tBatchJobName(apiClient, fromName));
...
export function deleteResourceJobFromMldev(fromObject) {
    const toObject = {};
...
export function deleteResourceJobFromVertex(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
...
export function embedContentBatchToMldev(apiClient, fromObject) {
    const toObject = {};
    ...
    if (fromContents != null) {
        ...
        common.setValueByPath(toObject, ['requests[]', 'request', 'content'], transformedList);
    }
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
        common.setValueByPath(toObject, ['_self'], embedContentConfigToMldev(fromConfig, toObject));
...
export function embeddingsBatchJobSourceToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromFileName = common.getValueByPath(fromObject, ['fileName']);
    if (fromFileName != null) {
    ...
    if (fromInlinedRequests != null) {
        common.setValueByPath(toObject, ['requests'], embedContentBatchToMldev(apiClient, fromInlinedRequests));
    }
    return toObject;
}
...
export function getBatchJobParametersToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], t.tBatchJobName(apiClient, fromName));
...
export function getBatchJobParametersToVertex(apiClient, fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], t.tBatchJobName(apiClient, fromName));
...
export function inlinedRequestToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromModel = common.getValueByPath(fromObject, ['model']);
    if (fromModel != null) {
        common.setValueByPath(toObject, ['request', 'model'], t.tModel(apiClient, fromModel));
    }
    const fromContents = common.getValueByPath(fromObject, ['contents']);
    if (fromContents != null) {
    ...
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
        common.setValueByPath(toObject, ['request', 'generationConfig'], generateContentConfigToMldev(apiClient, fromConfig, common.getValueByPath(toObject, ['request'], {})));
    }
    return toObject;
}
export function inlinedResponseFromMldev(fromObject) {
    const toObject = {};
    const fromResponse = common.getValueByPath(fromObject, ['response']);
    if (fromResponse != null) {
        common.setValueByPath(toObject, ['response'], generateContentResponseFromMldev(fromResponse));
    }
    const fromError = common.getValueByPath(fromObject, ['error']);
    if (fromError != null) {
        common.setValueByPath(toObject, ['error'], fromError);
...
export function listBatchJobsConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function listBatchJobsConfigToVertex(fromObject, parentObject) {
    const toObject = {};
    const fromPageSize = common.getValueByPath(fromObject, ['pageSize']);
    if (parentObject !== undefined && fromPageSize != null) {
        common.setValueByPath(parentObject, ['_query', 'pageSize'], fromPageSize);
...
export function listBatchJobsParametersToMldev(fromObject) {
    const toObject = {};
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function listBatchJobsParametersToVertex(fromObject) {
    const toObject = {};
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function listBatchJobsResponseFromMldev(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
...
export function listBatchJobsResponseFromVertex(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
