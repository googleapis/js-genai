...
export function createFileSearchStoreConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function createFileSearchStoreParametersToMldev(fromObject) {
    const toObject = {};
...
export function deleteFileSearchStoreConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function deleteFileSearchStoreParametersToMldev(fromObject) {
    const toObject = {};
...
export function getFileSearchStoreParametersToMldev(fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], fromName);
...
export function importFileConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function importFileParametersToMldev(fromObject) {
    const toObject = {};
    const fromFileSearchStoreName = common.getValueByPath(fromObject, [
        'fileSearchStoreName',
    ]);
    if (fromFileSearchStoreName != null) {
        common.setValueByPath(toObject, ['_url', 'file_search_store_name'], fromFileSearchStoreName);
    }
...
export function listFileSearchStoresConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function listFileSearchStoresParametersToMldev(fromObject) {
    const toObject = {};
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function listFileSearchStoresResponseFromMldev(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
...
export function uploadToFileSearchStoreConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function uploadToFileSearchStoreParametersToMldev(fromObject) {
    const toObject = {};
    const fromFileSearchStoreName = common.getValueByPath(fromObject, [
        'fileSearchStoreName',
    ]);
...
export function uploadToFileSearchStoreResumableResponseFromMldev(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
