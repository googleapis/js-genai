...
export function cancelTuningJobParametersToMldev(fromObject, _rootObject) {
    const toObject = {};
...
export function cancelTuningJobParametersToVertex(fromObject, _rootObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], fromName);
...
export function createTuningJobConfigToMldev(fromObject, parentObject, _rootObject) {
    const toObject = {};
    ...
    if (parentObject !== undefined && fromTunedModelDisplayName != null) {
        common.setValueByPath(parentObject, ['displayName'], fromTunedModelDisplayName);
    }
    ...
    if (parentObject !== undefined && fromEpochCount != null) {
        common.setValueByPath(parentObject, ['tuningTask', 'hyperparameters', 'epochCount'], fromEpochCount);
    }
    const fromLearningRateMultiplier = common.getValueByPath(fromObject, [
        'learningRateMultiplier',
    ]);
    if (fromLearningRateMultiplier != null) {
        common.setValueByPath(toObject, ['tuningTask', 'hyperparameters', 'learningRateMultiplier'], fromLearningRateMultiplier);
    }
    if (common.getValueByPath(fromObject, ['exportLastCheckpointOnly']) !==
        undefined) {
        throw new Error('exportLastCheckpointOnly parameter is not supported in Gemini API.');
    }
    if (common.getValueByPath(fromObject, ['preTunedModelCheckpointId']) !==
        undefined) {
    ...
    if (parentObject !== undefined && fromBatchSize != null) {
        common.setValueByPath(parentObject, ['tuningTask', 'hyperparameters', 'batchSize'], fromBatchSize);
    }
    const fromLearningRate = common.getValueByPath(fromObject, ['learningRate']);
    if (parentObject !== undefined && fromLearningRate != null) {
        common.setValueByPath(parentObject, ['tuningTask', 'hyperparameters', 'learningRate'], fromLearningRate);
    }
...
export function createTuningJobConfigToVertex(fromObject, parentObject, rootObject) {
    const toObject = {};
    ...
    if (discriminatorValidationDataset === 'SUPERVISED_FINE_TUNING') {
        ...
        if (parentObject !== undefined && fromValidationDataset != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec'], tuningValidationDatasetToVertex(fromValidationDataset, rootObject));
        }
    }
        ...
        if (parentObject !== undefined && fromValidationDataset != null) {
            common.setValueByPath(parentObject, ['preferenceOptimizationSpec'], tuningValidationDatasetToVertex(fromValidationDataset, rootObject));
        }
    }
    const fromTunedModelDisplayName = common.getValueByPath(fromObject, [
        'tunedModelDisplayName',
    ...
    if (parentObject !== undefined && fromTunedModelDisplayName != null) {
        common.setValueByPath(parentObject, ['tunedModelDisplayName'], fromTunedModelDisplayName);
    }
    ...
    if (discriminatorEpochCount === 'SUPERVISED_FINE_TUNING') {
        const fromEpochCount = common.getValueByPath(fromObject, ['epochCount']);
        if (parentObject !== undefined && fromEpochCount != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec', 'hyperParameters', 'epochCount'], fromEpochCount);
        }
    }
    else if (discriminatorEpochCount === 'PREFERENCE_TUNING') {
        const fromEpochCount = common.getValueByPath(fromObject, ['epochCount']);
        if (parentObject !== undefined && fromEpochCount != null) {
            common.setValueByPath(parentObject, ['preferenceOptimizationSpec', 'hyperParameters', 'epochCount'], fromEpochCount);
        }
    }
    ...
    if (discriminatorLearningRateMultiplier === 'SUPERVISED_FINE_TUNING') {
        ...
        if (parentObject !== undefined && fromLearningRateMultiplier != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec', 'hyperParameters', 'learningRateMultiplier'], fromLearningRateMultiplier);
        }
    }
    ...
    let discriminatorExportLastCheckpointOnly = common.getValueByPath(rootObject, ['config', 'method']);
    ...
    if (discriminatorExportLastCheckpointOnly === 'SUPERVISED_FINE_TUNING') {
        ...
        if (parentObject !== undefined && fromExportLastCheckpointOnly != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec', 'exportLastCheckpointOnly'], fromExportLastCheckpointOnly);
        }
    }
        ...
        if (parentObject !== undefined && fromExportLastCheckpointOnly != null) {
            common.setValueByPath(parentObject, ['preferenceOptimizationSpec', 'exportLastCheckpointOnly'], fromExportLastCheckpointOnly);
        }
    }
    ...
    if (discriminatorAdapterSize === 'SUPERVISED_FINE_TUNING') {
        ...
        if (parentObject !== undefined && fromAdapterSize != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec', 'hyperParameters', 'adapterSize'], fromAdapterSize);
        }
    }
    else if (discriminatorAdapterSize === 'PREFERENCE_TUNING') {
        const fromAdapterSize = common.getValueByPath(fromObject, ['adapterSize']);
        if (parentObject !== undefined && fromAdapterSize != null) {
            common.setValueByPath(parentObject, ['preferenceOptimizationSpec', 'hyperParameters', 'adapterSize'], fromAdapterSize);
        }
    }
    ...
    if (parentObject !== undefined && fromBeta != null) {
        common.setValueByPath(parentObject, ['preferenceOptimizationSpec', 'hyperParameters', 'beta'], fromBeta);
    }
    return toObject;
}
export function createTuningJobParametersPrivateToMldev(fromObject, rootObject) {
    const toObject = {};
...
export function createTuningJobParametersPrivateToVertex(fromObject, rootObject) {
    const toObject = {};
    const fromBaseModel = common.getValueByPath(fromObject, ['baseModel']);
    if (fromBaseModel != null) {
        common.setValueByPath(toObject, ['baseModel'], fromBaseModel);
...
export function getTuningJobParametersToMldev(fromObject, _rootObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], fromName);
...
export function getTuningJobParametersToVertex(fromObject, _rootObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], fromName);
...
export function listTuningJobsConfigToMldev(fromObject, parentObject, _rootObject) {
    const toObject = {};
...
export function listTuningJobsConfigToVertex(fromObject, parentObject, _rootObject) {
    const toObject = {};
    const fromPageSize = common.getValueByPath(fromObject, ['pageSize']);
    if (parentObject !== undefined && fromPageSize != null) {
        common.setValueByPath(parentObject, ['_query', 'pageSize'], fromPageSize);
...
export function listTuningJobsParametersToMldev(fromObject, rootObject) {
    const toObject = {};
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function listTuningJobsParametersToVertex(fromObject, rootObject) {
    const toObject = {};
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
...
export function listTuningJobsResponseFromMldev(fromObject, rootObject) {
    const toObject = {};
...
export function listTuningJobsResponseFromVertex(fromObject, rootObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
...
export function tunedModelFromMldev(fromObject, _rootObject) {
    const toObject = {};
...
export function tuningDatasetToMldev(fromObject, _rootObject) {
    const toObject = {};
    if (common.getValueByPath(fromObject, ['gcsUri']) !== undefined) {
        throw new Error('gcsUri parameter is not supported in Gemini API.');
    }
    if (common.getValueByPath(fromObject, ['vertexDatasetResource']) !== undefined) {
...
export function tuningDatasetToVertex(fromObject, parentObject, rootObject) {
    const toObject = {};
    ...
    if (discriminatorGcsUri === 'SUPERVISED_FINE_TUNING') {
        ...
        if (parentObject !== undefined && fromGcsUri != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec', 'trainingDatasetUri'], fromGcsUri);
        }
    }
    else if (discriminatorGcsUri === 'PREFERENCE_TUNING') {
        const fromGcsUri = common.getValueByPath(fromObject, ['gcsUri']);
        if (parentObject !== undefined && fromGcsUri != null) {
            common.setValueByPath(parentObject, ['preferenceOptimizationSpec', 'trainingDatasetUri'], fromGcsUri);
        }
    }
    ...
    if (discriminatorVertexDatasetResource === 'SUPERVISED_FINE_TUNING') {
        ...
        if (parentObject !== undefined && fromVertexDatasetResource != null) {
            common.setValueByPath(parentObject, ['supervisedTuningSpec', 'trainingDatasetUri'], fromVertexDatasetResource);
        }
    }
        ...
        if (parentObject !== undefined && fromVertexDatasetResource != null) {
            common.setValueByPath(parentObject, ['preferenceOptimizationSpec', 'trainingDatasetUri'], fromVertexDatasetResource);
        }
    }
...
export function tuningJobFromMldev(fromObject, rootObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
    ...
    if (fromTunedModel != null) {
        common.setValueByPath(toObject, ['tunedModel'], tunedModelFromMldev(fromTunedModel, rootObject));
    }
    return toObject;
}
export function tuningJobFromVertex(fromObject, _rootObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
    ...
    if (fromSupervisedTuningSpec != null) {
        common.setValueByPath(toObject, ['supervisedTuningSpec'], fromSupervisedTuningSpec);
    }
    const fromPreferenceOptimizationSpec = common.getValueByPath(fromObject, [
        'preferenceOptimizationSpec',
    ]);
    if (fromPreferenceOptimizationSpec != null) {
        common.setValueByPath(toObject, ['preferenceOptimizationSpec'], fromPreferenceOptimizationSpec);
    }
    ...
    if (fromPartnerModelTuningSpec != null) {
        common.setValueByPath(toObject, ['partnerModelTuningSpec'], fromPartnerModelTuningSpec);
    }
    ...
    if (fromTunedModelDisplayName != null) {
        common.setValueByPath(toObject, ['tunedModelDisplayName'], fromTunedModelDisplayName);
    }
...
export function tuningOperationFromMldev(fromObject, _rootObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
...
export function tuningValidationDatasetToVertex(fromObject, _rootObject) {
    const toObject = {};
    const fromGcsUri = common.getValueByPath(fromObject, ['gcsUri']);
    if (fromGcsUri != null) {
    ...
    if (fromVertexDatasetResource != null) {
        common.setValueByPath(toObject, ['validationDatasetUri'], fromVertexDatasetResource);
    }
    return toObject;
}
