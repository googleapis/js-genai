...
export function createFileParametersToMldev(fromObject) {
    const toObject = {};
...
export function createFileResponseFromMldev(fromObject) {
    const toObject = {};
...
export function deleteFileParametersToMldev(fromObject) {
    const toObject = {};
...
export function deleteFileResponseFromMldev(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
...
export function getFileParametersToMldev(fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'file'], t.tFileName(fromName));
...
export function listFilesConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function listFilesParametersToMldev(fromObject) {
    const toObject = {};
...
export function listFilesResponseFromMldev(fromObject) {
    const toObject = {};
    const fromSdkHttpResponse = common.getValueByPath(fromObject, [
        'sdkHttpResponse',
    ]);
