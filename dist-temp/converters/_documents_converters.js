...
export function deleteDocumentConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function deleteDocumentParametersToMldev(fromObject) {
    const toObject = {};
...
export function getDocumentParametersToMldev(fromObject) {
    const toObject = {};
    const fromName = common.getValueByPath(fromObject, ['name']);
    if (fromName != null) {
        common.setValueByPath(toObject, ['_url', 'name'], fromName);
...
export function listDocumentsConfigToMldev(fromObject, parentObject) {
    const toObject = {};
...
export function listDocumentsParametersToMldev(fromObject) {
    const toObject = {};
...
export function listDocumentsResponseFromMldev(fromObject) {
    const toObject = {};
