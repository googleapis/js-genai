...
export function createAuthTokenConfigToMldev(apiClient, fromObject, parentObject) {
    const toObject = {};
    ...
    if (parentObject !== undefined && fromNewSessionExpireTime != null) {
        common.setValueByPath(parentObject, ['newSessionExpireTime'], fromNewSessionExpireTime);
    }
    ...
    if (parentObject !== undefined && fromLiveConnectConstraints != null) {
        common.setValueByPath(parentObject, ['bidiGenerateContentSetup'], liveConnectConstraintsToMldev(apiClient, fromLiveConnectConstraints));
    }
    const fromLockAdditionalFields = common.getValueByPath(fromObject, [
        'lockAdditionalFields',
    ]);
    if (parentObject !== undefined && fromLockAdditionalFields != null) {
        common.setValueByPath(parentObject, ['fieldMask'], fromLockAdditionalFields);
    }
    return toObject;
}
export function createAuthTokenParametersToMldev(apiClient, fromObject) {
    const toObject = {};
    const fromConfig = common.getValueByPath(fromObject, ['config']);
    if (fromConfig != null) {
        common.setValueByPath(toObject, ['config'], createAuthTokenConfigToMldev(apiClient, fromConfig, toObject));
    }
    return toObject;
}
export function createAuthTokenParametersToVertex(fromObject) {
    const toObject = {};
...
export function liveConnectConstraintsToMldev(apiClient, fromObject) {
    const toObject = {};
