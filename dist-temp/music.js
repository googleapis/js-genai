...
async function handleWebSocketMessage(apiClient, onmessage, event) {
    const serverMessage = new types.LiveMusicServerMessage();
    let data;
...
export class LiveMusicSession {
    ...
    async setWeightedPrompts(params) {
        ...
        const clientContent = converters.liveMusicSetWeightedPromptsParametersToMldev(params);
    ...
    async setMusicGenerationConfig(params) {
        ...
        const setConfigParameters = converters.liveMusicSetConfigParametersToMldev(params);
