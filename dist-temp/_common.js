...
export function formatMap(templateString, valueMap) {
...
export function setValueByPath(data, keys, value) {
...
export function getValueByPath(data, keys, defaultValue = undefined) {
    try {
 ...
 */
export function moveValueByPath(data, paths) {
