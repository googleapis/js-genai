...
c8  --exclude="src/private/**" --exclude="dist/test-build/src/private/**" --reporter=json --report-dir=./${WORK_DIR}/${UNIT} jasmine dist/test-build/test/unit/**/*_test.js dist/test-build/test/unit/*_test.js
c8  --exclude="src/private/**" --exclude="dist/test-build/src/private/**" --reporter=json --report-dir=./${WORK_DIR}/${SYSTEM} jasmine dist/test-build/test/system/node/*_test.js -- --test-server
