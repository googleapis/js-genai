...
describe('Client Tests', () => {
  ...
  describe('generateContent', () => {
    ...
    it('Vertex AI can use use both default in anyOf in parametersJsonSchema', async () => {
              ...
              functionDeclarations: [
                {
                  name: 'concatStringFunction',
                  description: 'this is a concat string function',
                  parametersJsonSchema: combinedSchema,
                },
              ],
            },
          ],
      ...
      console.log('vertex ai response', response.functionCalls);
    });
    it('Vertex AI can use use both default in anyOf in parametersSchema (complex schema)', async () => {
      const combinedSchema = {
        type: 'object',
        properties: {
          prop1: {
    ...
    fit('Vertex AI can use use any format in parametersJsonSchema', async () => {
      const combinedSchema = {
        type: 'object',
        properties: {
          firstString: {
      ...
      console.log('vertex ai response with any format', response.functionCalls);
    });
    it('Vertex AI can use use any format in parametersJsonSchema', async () => {
      const combinedSchema = {
        type: 'object',
        properties: {
          firstString: {
