...
describe('tSchema', () => {
  ...
  it('should throw error for tuple schema due to item field data type mismatch', () => {
    ...
    expect(() =>
      tSchema(
        vertexApiClient,
        zodToJsonSchema(tupleSchema) as Record<string, unknown>,
      ),
    ).toThrowError();
    expect(() =>
      tSchema(
  ...
  it('should throw error for set schema due to unsupported property: uniqueItems', () => {
    ...
    expect(() =>
      tSchema(
        vertexApiClient,
        zodToJsonSchema(setSchema) as Record<string, unknown>,
      ),
    ).toThrowError();
    expect(() =>
      tSchema(
  ...
  it('should throw error for nested zod object referred twice due to unsupported property: $ref', () => {
    ...
    expect(() =>
      tSchema(
        vertexApiClient,
        zodToJsonSchema(nestedSchema) as Record<string, unknown>,
      ),
    ).toThrowError();
    expect(() =>
      tSchema(
  ...
  it('should process simple zod object, with optional fields', () => {
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(zodSchema) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process primitive types directly', () => {
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(stringDirectly) as Record<string, unknown>,
      ),
    ).toEqual(expectedStringDirectly);
    expect(
      tSchema(
        mlDevApiClient,
        zodToJsonSchema(stringDirectly) as Record<string, unknown>,
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(numberDirectly) as Record<string, unknown>,
      ),
    ).toEqual(expectedNumberDirectly);
    expect(
      tSchema(
        mlDevApiClient,
        zodToJsonSchema(numberDirectly) as Record<string, unknown>,
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(integerDirectly) as Record<string, unknown>,
      ),
    ).toEqual(expectedIntegerDirectly);
    expect(
      tSchema(
        mlDevApiClient,
        zodToJsonSchema(integerDirectly) as Record<string, unknown>,
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(booleanDirectly) as Record<string, unknown>,
      ),
    ).toEqual(expectedBooleanDirectly);
    expect(
      tSchema(
        mlDevApiClient,
        zodToJsonSchema(booleanDirectly) as Record<string, unknown>,
  ...
  it('should process zod array of objects', () => {
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(objectArray) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process default value', () => {
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(defaultObject) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process primitive nullables', () => {
    ...
    */
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(objectNullable) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process nullable array and remove anyOf filed when necessary', () => {
    ...
    */
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(nullableArray) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process union consist of only not-nullable primitive types without additional fields', () => {
    ...
    */
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(unionPrimitives) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process union objects', () => {
    ...
    */
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(unionPrimitivesAndObjects) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
  ...
  it('should process union array and objects', () => {
    ...
    */
    ...
    expect(
      tSchema(
        vertexApiClient,
        zodToJsonSchema(uninonArrayAndObjects) as Record<string, unknown>,
      ),
    ).toEqual(expected);
    expect(
      tSchema(
